...
RpbErrorResp = _reflection.GeneratedProtocolMessageType('RpbErrorResp', (_message.Message,), {
  'DESCRIPTOR' : _RPBERRORRESP,
  '__module__' : 'riak.pb.riak_pb2'
  # @@protoc_insertion_point(class_scope:RpbErrorResp)
  })
_sym_db.RegisterMessage(RpbErrorResp)

RpbGetServerInfoResp = _reflection.GeneratedProtocolMessageType('RpbGetServerInfoResp', (_message.Message,), {
...
RpbPair = _reflection.GeneratedProtocolMessageType('RpbPair', (_message.Message,), {
  'DESCRIPTOR' : _RPBPAIR,
  '__module__' : 'riak.pb.riak_pb2'
...
RpbGetBucketReq = _reflection.GeneratedProtocolMessageType('RpbGetBucketReq', (_message.Message,), {
...
RpbGetBucketResp = _reflection.GeneratedProtocolMessageType('RpbGetBucketResp', (_message.Message,), {
...
RpbSetBucketReq = _reflection.GeneratedProtocolMessageType('RpbSetBucketReq', (_message.Message,), {
...
RpbResetBucketReq = _reflection.GeneratedProtocolMessageType('RpbResetBucketReq', (_message.Message,), {
...
RpbGetBucketTypeReq = _reflection.GeneratedProtocolMessageType('RpbGetBucketTypeReq', (_message.Message,), {
...
RpbSetBucketTypeReq = _reflection.GeneratedProtocolMessageType('RpbSetBucketTypeReq', (_message.Message,), {
...
RpbModFun = _reflection.GeneratedProtocolMessageType('RpbModFun', (_message.Message,), {
...
RpbCommitHook = _reflection.GeneratedProtocolMessageType('RpbCommitHook', (_message.Message,), {
...
RpbBucketProps = _reflection.GeneratedProtocolMessageType('RpbBucketProps', (_message.Message,), {
...
RpbAuthReq = _reflection.GeneratedProtocolMessageType('RpbAuthReq', (_message.Message,), {
